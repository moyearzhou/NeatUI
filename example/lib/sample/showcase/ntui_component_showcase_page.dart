...
class NTUIComponentCategory {
  final String title;
  final List<NTUIComponentItem> items;

  NTUIComponentCategory({
    required this.title,
    required this.items,
  });
}

class NTUIComponentShowcasePage extends StatelessWidget {
  final String title;
  final List<NTUIComponentCategory> categories;
  final Color backgroundColor;
  final List<Widget>? actions;

  const NTUIComponentShowcasePage({
    Key? key,
...
class _CategorySection extends StatelessWidget {
  final NTUIComponentCategory category;
