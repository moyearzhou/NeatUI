import 'package:example/sample/appbar/demo_app_bar.dart';
import 'package:flutter/material.dart';

/// NTUI 按钮演示页
class NTUIButtonDemoPage extends StatelessWidget {
  const NTUIButtonDemoPage({super.key});
