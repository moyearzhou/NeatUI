...
/// GTUI 徽标演示页
class NTUIBadgeDemoPage extends StatelessWidget {
  const NTUIBadgeDemoPage({super.key});

  static const Color _badgeRed = Color(0xFFFF3141);
  static const Color _iconBg = Color(0x88FF3141);
      ...
      child: Stack(
        ...
        children: [
          Container(
            ...
            // child: const Icon(Icons.notifications_none_outlined, size: 26, color: Color(0xFF666666)),
          ),
          Positioned(
